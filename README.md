...
dataset to analyze the dynamics of football matches. 
It has two important areas:
...
and feature engineering (e.g., shot distance, angle, and player positions).
Using only tracking
data, possession was modeled as a regression task. 
Aim is to provide a simple procedure
